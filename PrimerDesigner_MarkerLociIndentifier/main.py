...
class QuasialignmentStrategy(Strategy):
    ...
    def process_panaroo_output(presence_absence_file, gene_data_file):
        ...
        `output/panaroo/processed/`. The file is named after the gene name and contains the species name,
        DNA sequence, and gene name in the order: gene name, species name, DNA sequence.
        ...
        with open(presence_absence_file, mode='r', newline='') as presence_absence_csv:
            ...
            for row in presence_absence_reader:
                ...
                # Create a new file for this gene
                ...
                with open(output_file_path, mode='w', newline='') as output_csv:
                    ...
                    # Start looping from the 4th column onwards in presence_absence.csv
                    for cell in row[3:]:
